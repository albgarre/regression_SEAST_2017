...
```{r}
GradosTeleco <- read.table("data/notamediagradosETSIT-completo.csv", header = TRUE, sep= ";", dec= ".", stringsAsFactors=FALSE)
...
training.posiciones <- sample(nrow(GradosTeleco), size = 70, replace = FALSE, prob = NULL)
